...
$query = $db->prepare("SELECT x.*, y.* FROM nota x, isi_nota y WHERE YEAR(x.tgl_nota) = '$thn' AND MONTH(x.tgl_nota) = '$bln' AND x.no_nota = y.no_nota");
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Cetak Laporan Barang KMasuk</h3>
