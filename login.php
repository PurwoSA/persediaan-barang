  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="index2.html"><b>Umar</b>Bakery</a>
      </div>
      <!-- /.login-logo -->
      <div class="login-box-body">
        ...
        <form id="loginform" method="post">
          ...
          <div class="row">
            <!-- /.col -->
            <div class="col-xs-4">
              <button type="submit" class="btn btn-primary btn-block btn-flat" name="kirim"><i class="fa fa-sign-in"></i> Masuk</button>
            </div>
            <!-- /.col -->
          </div>
        </form>
