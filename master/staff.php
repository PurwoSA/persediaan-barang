    ...
    <ul>
      ...
      <li class="submenu"> <a href="#"><i class="fa fa-pencil-square fa-fw"></i> <span>Transaksi</span></a>
        <ul>
          ...
          <li><a href="../transaksi/barang_keluar.html"><i class="fa fa-shopping-cart fa-fw"></i> Isi Barang Keluar</a></li>
          <li><a href="../transaksi/ttb.html"><i class="fa fa-reply fa-fw"></i> Tanda Terima Barang</a></li>
        </ul>
      </li>
